...
@injectable()
export class PapyrusGLSPDiagramClient extends GLSPDiagramClient {
    constructor(
        @inject(PapyrusGLSPClientContribution) glspCLientContribution: PapyrusGLSPClientContribution,
