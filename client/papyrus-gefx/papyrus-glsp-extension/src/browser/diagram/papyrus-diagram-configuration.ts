...
import { createGefxDiagramContainer } from "papyrus-sprotty/lib";
...
@injectable()
export class PapyrusDiagramConfiguration implements DiagramConfiguration {
    @inject(SelectionService) protected selectionService: SelectionService;
    diagramType: string = GEFxLanguage.DiagramType;

    createContainer(widgetId: string): Container {
        const container = createGefxDiagramContainer(widgetId);
